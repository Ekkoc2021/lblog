...
import { getAuthorCategories, createCategory, updateCategory, deleteCategory } from '../../services/api';
...
const CategoryManage: React.FC = () => {
  ...
  const loadData = () => {
    setLoading(true);
    getAuthorCategories({ page: 1, pageSize: 100 }).then(res => { setCategories(res.data.list); setTotal(res.data.total); }).catch((e: Error) => message.error(e.message)).finally(() => setLoading(false));
  };

...
public class ImageUsageAspect {
    ...
    @AfterReturning(pointcut = "execution(* com.yang.lblogserver.blog.service.PostsService.createPost(..))", returning = "postId")
    ...
    @AfterReturning("execution(* com.yang.lblogserver.blog.service.PostsService.updatePost(..))")
    @Transactional(rollbackFor = Exception.class)
    ...
    @AfterReturning("execution(* com.yang.lblogserver.blog.service.PostsService.deletePost(..))")
    @Transactional(rollbackFor = Exception.class)

...
import com.yang.lblogserver.blog.vo.LikeResponseVO;
import com.yang.lblogserver.blog.vo.LikeStatusVO;
import com.yang.lblogserver.blog.vo.PostDetailVO;
...
public class PostsServiceImpl implements PostsService {
    ...
    public PageResult<PostVO> getPostList(int page, int pageSize, String sort,
        ...
        Map<Long, Users> userMap = authorIds.isEmpty() ? Collections.emptyMap() :
                userQueryService.selectBatchIds(new ArrayList<>(authorIds)).stream()
    ...
    private void assemblePostRelations(Posts post, PostVO vo) {
        // 作者
        List<Users> users = userQueryService.selectBatchIds(Collections.singletonList(post.getAuthorId()));
        if (!users.isEmpty()) {

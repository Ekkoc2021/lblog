...
public class ConfigController {
    ...
    public ConfigController(FileStorage fileStorage, SiteConfigMapper siteConfigMapper) {
    ...
    public ApiResponse<?> setRegistrationEnabled(@RequestBody RegistrationToggleRequest request) {
        siteConfigMapper.updateConfigValue("registration_enabled",
